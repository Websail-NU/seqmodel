...
IMPORTANT: This code is taken directly from Google's seq2seq
...
class GraphModule(object):
    ...
    def __init__(self, name):
        """
        Initialize the module. Each subclass must call this constructor
        with a name.
        ...
        # Docstrings for the class should be the
        # docstring for the _build method
